...
const WEBHOOK_URL = process.env.WEBHOOK_URL || "https://dodo-backend-degkftv98-umars-projects-fa2018ce.vercel.app/api/bot";
...
bot.onText(/\/hello/, (msg) => {
  bot.sendMessage(msg.chat.id, "Привет! Это тестовая команда.");
});
